---
title: "Pagination"
description: "OpenXSwitch API uses pagination for REST endpoints that return array-based responses."
---

Pagination allows applications to retrieve large datasets in smaller, structured batches. Endpoints that return lists such as deposits, withdrawals, transactions, wallets, or swaps support pagination through the `pageNo` and `pageLimit` query parameters.
...
```javascript
GET {base}/v2/wallets/list?pageNo=1&pageLimit=20
```
