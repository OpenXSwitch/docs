---
title: "Wallet as a Service: Sandbox vs Live"
sidebarTitle: "Sandbox vs Live"
description: "Within the Wallet-as-a-Service section of OpenXSwitch, the Console displays only Live data for production monitoring, while Sandbox is simulation-only and accessible via API for safe development and testing."
---
