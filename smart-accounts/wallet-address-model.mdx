---
title: "Smart Accounts: Wallet Address Model"
description: "The Smart Account Wallet Address Model defines how OpenXSwitch generates and manages onchain wallet addresses for Smart Accounts."
sidebarTitle: "Wallet Address Model"
---

**Smart Account** addresses/wallets are generated per **protocol model** and are tied to a **smart account** entity, directly reflecting blockchain-native ownership on supported networks.
