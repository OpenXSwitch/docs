...
A single wallet address can be used to receive supported assets across multiple EVM chains and tokens. To learn more, see [Unified Wallet Addressing on EVM Chains](/wallet-infrastructure/unified-evm-address).
